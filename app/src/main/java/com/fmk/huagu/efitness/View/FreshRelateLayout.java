...
/**
 * Created by huagu on 2016/11/1.
 */

public class FreshRelateLayout extends RelativeLayout {
    ...
    public FreshRelateLayout(Context context) {
        super(context);
        initView(context);
    }

    public FreshRelateLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public FreshRelateLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class AutoRefreshAndLoadTask extends AsyncTask<Integer, Float, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            // 刷新操作
            if (mListener != null)
                mListener.onRefresh(FreshRelateLayout.this);
            hide();
        }
...
//                if (!(pullableView instanceof FreshScrollView)){
//                    new Throwable(TAG+" :添加子布局错误了").printStackTrace();
//                }
//            }else if (getChildCount() == 2){
//                if (getChildAt(0) instanceof FreshScrollView){
//                    pullableView = getChildAt(0);
...
//            }else{
//                new Throwable(TAG+" :添加子布局最多3个").printStackTrace();
//            }

            refreshView = LayoutInflater.from(mContext).inflate(R.layout.refresh_head, null, false);
            addView(refreshView, 0);
            loadmoreView = LayoutInflater.from(mContext).inflate(R.layout.load_more, null, false);
    ...
    public interface OnRefreshListener {
         ...
         * 刷新操作
         */
        void onRefresh(FreshRelateLayout pullToRefreshLayout);

        /**
         * 加载操作
         */
        void onLoadMore(FreshRelateLayout pullToRefreshLayout);
    }
